...
export class Tab2Page implements OnInit {
  ...
  this.linesService.getLines().subscribe((res: any) => {
    ...
    this.linha10horario1 = this.linha10.filter((e: any) => e.horarios.semana === "Segunda á Sábado - Fórum")
    this.linha10horario2 = this.linha10.filter((e: any) => e.horarios.semana === "Segunda á Sábado - Terminal Urbano (centro)")
